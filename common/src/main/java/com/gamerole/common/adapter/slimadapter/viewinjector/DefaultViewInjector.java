package com.gamerole.common.adapter.slimadapter.viewinjector;
...
import com.gamerole.common.adapter.slimadapter.SlimViewHolder;
import com.gamerole.common.util.ImageUtil;
...
public class DefaultViewInjector implements IViewInjector<DefaultViewInjector> {
    ...
    public DefaultViewInjector image(int id, String url) {
        ImageUtil.setImage(url, findViewById(id));
        return this;
    }
